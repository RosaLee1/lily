...
static inline void NoiseSampleP__SendSerial__runTask(void )
{
  ...
  __nesc_hton_uint32(msg.this_rxTimestamp.nxdata, NoiseSampleP__rxTimestamp[(uint8_t )(NoiseSampleP__Addr_offset / TOTAL_SIZE - 1)]);
  __nesc_hton_uint16(msg.this_counter.nxdata, NoiseSampleP__my_counter[(uint8_t )(NoiseSampleP__Addr_offset / TOTAL_SIZE - 1)]);
